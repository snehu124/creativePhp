...
<head>
    ...
    <title>Kiddino - Children School & Kindergarten HTML Template - Shopping Cart</title>
                ...
                <table class="cart_table">
                    ...
                    <tbody>
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="shop-detailis.html"><img width="91" height="91"
                                        src="assets/img/product/product1-1.png" alt="product"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-detailis.html">The Bubblegum Toy</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>27.00</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="shop-detailis.html"><img width="91" height="91"
                                        src="assets/img/product/product1-2.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-detailis.html">Table harmoni play</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>24.00</bdi></span>
                            </td>
                            <td data-title="Quantity">
                                <div class="quantity">
                                    <button class="quantity-minus qty-btn"><i class="far fa-chevron-down"></i></button>
                    ...
                    <table class="cart_totals">
                        <tbody>
                            <tr>
                                ...
                                <td data-title="Cart Subtotal">
                                    <span class="amount"><bdi><span>$</span>52.00</bdi></span>
                                </td>
                            </tr>
                            <tr class="shipping">
                                ...
                                <td data-title="Shipping and Handling">
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="shipping-calculator-form">
                                            ...
                                            <p>
                                                <button class="vs-btn shadow-none">Update</button>
                                            </p>
                                        </div>
                                    </form>
                                </td>
                        ...
                        <tfoot>
                            <tr class="order-total">
                                <td>Order Total</td>
                                <td data-title="Total">
                                    <strong><span class="amount"><bdi><span>$</span>52.00</bdi></span></strong>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                    <div class="wc-proceed-to-checkout mb-30">
                        <a href="checkout.html" class="vs-btn">Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>
