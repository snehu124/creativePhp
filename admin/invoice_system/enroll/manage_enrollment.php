...
<a href="#"
   class="btn btn-edit menu-link"
   data-page="invoice_system/enroll/edit_enrollment.php?student_id=<?php echo $row['student_id']; ?>">
   <i class="bi bi-pencil"></i> Edit
</a>

<a href="#"
   class="btn btn-history menu-link"
   data-page="invoice_system/enroll/plan_history.php?student_id=<?php echo $row['student_id']; ?>">
