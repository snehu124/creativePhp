...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar">
            ...
            <a href="enrolled_subjects.php"><i class="bi bi-list-check"></i> Enrolled Subjects</a>
            ...
            <!--<a href="#purchase"><i class="bi bi-receipt"></i> Purchase History</a>-->
            <a href="purchase_history.php" class="active"><i class="bi bi-receipt"></i> Purchase History</a>
            <a href="#settings"><i class="bi bi-gear"></i> Settings</a>
            <a href="math_practice.php"><i class="bi bi-book"></i> Math Practice</a>
            <a href="student_logout.php" class="btn btn-sm btn-danger mt-3">Logout</a>
        </div>

        <!-- Main Content -->
        <div class="col-md-9 col-lg-10 content">
            <h3 class="mb-4">ðŸŽ“ Welcome, <?= htmlspecialchars($student['first_name']) ?></h3>
            ...
            <section id="subjects" class="mb-4">
                <div class="card p-4">
                    <h5><i class="bi bi-list-check"></i> Enrolled Subjects</h5>
                    ...
                    <?php if ($materials_result && mysqli_num_rows($materials_result) > 0): ?>
                        <?php while ($mat = mysqli_fetch_assoc($materials_result)): ?>
                            <div class="col-md-6 mb-4">
                                <div class="card p-3">
                                    <h6 class="fw-semibold"><?= htmlspecialchars(basename($mat['file_path'])) ?></h6>
                                    <small class="text-muted mb-2 d-block"><?= htmlspecialchars($mat['subject_name']) ?></small>
           ...
           <!-- Progress Tracker -->
<section id="progress" class="mt-5">
    <div class="card p-4">
        <h5><i class="bi bi-bar-chart-fill"></i> Learning Progress</h5>
        <?php if ($progress_result && mysqli_num_rows($progress_result) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($progress_result)): ?>
                ...
                ?>
                <div class="mb-3">
                    <h6><?= htmlspecialchars($row['subject_name']) ?></h6>
                    <p>ðŸ“˜ Chapters: <?= $row['total_chapters'] ?> | ðŸ§  Attempted: <?= $row['attempted'] ?> | âœ… Correct: <?= $row['correct_answers'] ?></p>
        ...
        <?php endif; ?>
            ...
            <!-- Purchase History -->
            <section id="purchase" class="mt-5">
                <div class="card p-4">
