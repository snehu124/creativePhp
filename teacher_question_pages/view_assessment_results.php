...
<a href="teacher_dashboard.php?page=teacher_question_pages/view_student_answers.php&assessment_id=<?= $assessment_id ?>&student_id=<?= $row['student_id'] ?>&submitted_at=<?= urlencode($row['submitted_at']) ?>"
